...
results_df %>%
    ...
    labs(title = "Accuracy of different cross-validation methods",
...
results_df %>%
    ...
    geom_bar(stat = "identity", position = "dodge") +
    labs(title = "Precision of different cross-validation methods",
         x = "Cross-Validation Method",
         y = "Precision") +
    theme(plot.title = element_text(hjust = 0.5))
```
...
results_df %>%
    ...
    geom_bar(stat = "identity", position = "dodge") +
    labs(title = "Recall of different cross-validation methods",
         x = "Cross-Validation Method",
         y = "Recall") +
    theme(plot.title = element_text(hjust = 0.5))
```
...
results_df %>%
    ...
    geom_bar(stat = "identity", position = "dodge") +
    labs(title = "F1 Score of different cross-validation methods",
         x = "Cross-Validation Method",
         y = "F1 Score") +
    theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
# calculate positive to negative review_type ratio
pos_neg_ratio <- data %>%
